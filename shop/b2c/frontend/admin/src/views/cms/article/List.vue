<template>
  <div>
    ...
    <el-row :gutter="8">
      ...
      <el-col :span="10">
        <el-input size="small" v-model="searchKeyword" placeholder="请输入文章标题或分类名称"></el-input>
      </el-col>
      <el-col :span="2">
  ...
  <el-table border :data="tableData" style="width: 100%">
    ...
    <el-table-column label="点击量 / 评论量"
          width="120">
      <template slot-scope="scope">
          {{scope.row.clickCount}} / {{scope.row.commentCount}}
      </template>
    </el-table-column>
  ...
  data () {
    return {
      tableData: [{
        ...
        commentCount: '0',
        status: '已发布',
        publishDate: '2018-07-18 14:09:46',
        sort: '22'
      }, {
        id: '2',
        title: 'rewqrewqrqew',
        ...
        commentCount: '4312',
        status: '已发布',
        publishDate: '2018-08-06 10:11:56',
        sort: '33'
      }]
    }
  },
