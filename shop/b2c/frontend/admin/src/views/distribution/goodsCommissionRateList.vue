  ...
  <div>
    ...
    <el-table border :data="tableData" style="width: 100%">
      ...
      <el-table-column
            ...
            <a target="_blank" :href="scope.row.goodsLink">{{scope.row.goodsName}}</a>
          <br/>
      ...
      <el-table-column label="操作" fixed="right"
          ...
          <template slot-scope="scope">
              ...
              <br/>
              <el-button size="mini" class="margin-top-5" v-show="!scope.row.isOpen" @click="handleEdit(scope.$index, scope.row)">开启分销</el-button>
              <el-button size="mini" class="margin-top-5" v-show="scope.row.isOpen" @click="handleEdit(scope.$index, scope.row)">关闭分销</el-button>
          </template>
      </el-table-column>
    </el-table>
