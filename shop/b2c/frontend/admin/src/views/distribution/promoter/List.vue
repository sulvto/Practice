<template>
  <div>
    ...
    <div v-if="false">
      ...
      <!-- 修改用户上级（Modal）开始 -->
      <div class="modal fade hide" data-id="editParent" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h3 class="modal-title" data-id="myModalLabel">推广员上级修改</h3>
            </div>
            <div class="modal-body">
              <div class="modal-div">
                <input type="hidden" data-id="promoter_id" value="">
                <dl class="modal-dl">
                  <dt>上级推广员编号:</dt>
                  <dd>
                    <input type="text" data-id="parent_promoter" value="">
                    <span id="ever_parent_promoter" />
                  </dd>
                </dl>
              </div>
            </div>
      ...
      <div class="modal fade hide" data-id="editLevel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h3 class="modal-title" data-id="myModalLabel">推广员等级修改</h3>
            </div>
            <div class="modal-body">
              <div class="modal-div">
                <input type="hidden" data-id="level_promoter_id" value="">
                <dl class="modal-dl">
                  <dt>推广员等级:</dt>
                  <dd>
                    <select id="level_id">
      ...
      <!--修改店铺名称  -->
      <div class="modal fade hide" data-id="editShopName" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h3 class="modal-title" data-id="myModalLabel">店铺名称修改</h3>
            </div>
            <div class="modal-body">
              <div class="modal-div">
                <input type="hidden" data-id="shop_promoter_id" value="">
                <dl class="modal-dl">

                  <dt>店铺名称：</dt>
                  <dd>
                    <input type="text" data-id="shop_name" value="">
                  </dd>
      ...
      <div class="modal fade hide" data-id="myTeam" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:60%;left:35%">

        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h3 class="modal-title" data-id="myModalLabel">我的团队
            ...
            <input type="hidden" value="" data-id="hidden_promoter_id">
            <div class="modal-footer">
              <button type="button" class="btn-common-cancle btn-big" data-dismiss="modal">关闭</button>
            </div>
          </div>
