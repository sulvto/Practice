...
<div class="set-style">
	...
	<dl>
		...
		<dd><input class="input-mini w70 input-common harf" onkeyup="value=value.replace(/\D/g,'')" type="number" id="max_num" value="111"><em class="unit">件</em>
			<p class="error" style="display: none;">请输入最大购买量</p>
		</dd>
	</dl>
<!-- 	<dl>
		<dt><span style="color:red;">*</span>&nbsp;&nbsp;最小购买量：</dt>
		<dd><input class="input-mini w70 input-common" onkeyup="value=value.replace(/\D/g,'')" type="text" id="min_num" value="1"><span class="help-inline">个</span>
