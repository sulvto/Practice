...
<template>
        <el-form ref="form" :model="coupontFrom" label-width="100px" size="mini" label-position="right">
            ...
            <el-form-item label="面额">
                <el-input type="number"  v-model="coupontFrom.denomination" >
            ...
            <el-form-item label="补发数量">
                <el-input type="number"  v-model="coupontFrom.repairCount" >
                    <template slot="append">
                            份
                        </template>
                </el-input>
            ...
            <el-form-item label="每人最大领取数">
                <el-input type="number"  v-model="coupontFrom.maxFetch" >
                    <template slot="append">
                            份
                        </template>
                </el-input>
            ...
            <el-form-item label="满多少元使用">
                <el-input type="number"  v-model="coupontFrom.atLeast" >
                    <template slot="append">
                            份
                        </template>
                </el-input>
