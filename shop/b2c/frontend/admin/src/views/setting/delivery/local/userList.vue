    ...
    <section class="ns-base-section">
        ...
        <div style="position:relative;margin:0;">
            ...
            <div class="breadcrumb-nav">
                ...
                <i class="fa fa-angle-right"></i>
                <!-- 需要加跳转链接用这个：http://showfx.niuteam.cn/admin/distribution/distributionUserList -->
                <a href="javascript:;" style="color:#999;">配送人员</a>
            </div>
            <!-- 三级导航菜单 -->
        ...
        <div class="ns-main">
            ...
            <div class="ncsc-form-goods">
                <nav class="goods-nav">
                    <ul>
                        <li class="selected"><a href="/distribution/distributionuserlist.html" child_id="1">配送人员</a></li>
                        ...
                        <div class="con style0list">
                            ...
                            <table class="table-class">
                                ...
                                <tbody id="productTbody">
                                    <tr align="center">
                                        <td><i class="checkbox-common"><input name="sub" type="checkbox" value="1"></i></td>
                                        <td align="left" class="tal">abc</td>
                                        <td align="left" class="tal">a3124</td>
                                        <td align="left" class="tal"></td>
                                        <td class="tal"><a onclick="distributionShow(1)">修改</a><a style="cursor: pointer;" onclick="DelDistributionUser(1)">删除</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
