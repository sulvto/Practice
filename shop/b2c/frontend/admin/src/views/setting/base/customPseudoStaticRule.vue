  ...
  data () {
    return {
      tableData: [
        ...
        {
          rule: 'integralcenter',
          address: 'shop/goods/integralcenter',
          isOpen: true,
          isDefault: true,
          module: 'shop',
          introduction: ''
        ...
        {
          rule: 'article',
          address: 'shop/cms/articleclassinfo',
          isOpen: true,
          isDefault: true,
          module: 'shop',
          introduction: ''
