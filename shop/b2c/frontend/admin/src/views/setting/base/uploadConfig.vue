  ...
  <el-form ref="form" :model="uploadConfigFrom" label-width="140px" size="mini" label-position="right">
    ...
    <el-form-item label="保存方式">
      <el-select v-model="uploadConfigFrom.visitMode" placeholder="请选择">
        ...
        <el-option label="七牛" value="qiniu" />
      </el-select>
    ...
    <div v-show="uploadConfigFrom.visitMode === 'qiniu'">
      ...
      <el-form-item label="Accesskey">
        <el-input v-model="uploadConfigFrom.accesskey" />
        <p class="hint">用于签名的公钥</p>
      </el-form-item>

      <el-form-item label="Secretkey">
        <el-input v-model="uploadConfigFrom.secretkey" />
        <p class="hint">用于签名的私钥</p>
      </el-form-item>

      <el-form-item label="Bucket">
        <el-input v-model="uploadConfigFrom.bucket" />
        <p class="hint">请保证bucket为可公共读取的</p>
      </el-form-item>

      <el-form-item label="Url">
        <el-input v-model="uploadConfigFrom.url" />
    ...
    <el-form-item label="商品图片添加水印">
      <el-switch v-model="uploadConfigFrom.watermark" active-text="是" inactive-text="否" />
    </el-form-item>
    ...
    <el-form-item label="水印位置">
      <el-checkbox-group v-model="uploadConfigFrom.waterPosition">
        <el-checkbox label="左上角" value="1" />
        <el-checkbox label="右上角" value="2" />
        <el-checkbox label="居中" value="3" />
        <el-checkbox label="左下角" value="4" />
        <el-checkbox label="右下角" value="5" />
      </el-checkbox-group>
    ...
    <el-form-item label="支持格式后缀">
      <el-input v-model="uploadConfigFrom.fileFormat" type="textarea"/>
    ...
    <el-form-item label="裁剪设置">
      <el-checkbox-group v-model="uploadConfigFrom.passwordComplexity">
        <el-checkbox label="缩放后填充" value="1" />
        <el-checkbox label="居中裁剪" value="2" />
        <el-checkbox label="左上角裁剪" value="3" />
        <el-checkbox label="右下角裁剪" value="4" />
        <el-checkbox label="固定尺寸缩放" value="5" />
      </el-checkbox-group>
