      ...
      <div class="upload-btn">
        ...
        <p><i class="fa fa-upload"></i>上传图片</p>
            ...
            <el-form-item label="封面图片显示在正文中">
              <el-switch  active-text="是" inactive-text="否" v-model="editForm.showCoverPicture"></el-switch>
            </el-form-item>
            ...
            <el-form-item label="正文" required>
              <UEditor :content="editForm.content" :config="{initialFrameHeight: '400'}" ref="ue"/>
            </el-form-item>

            <el-form-item label="原文链接" >
              <el-input v-model="editForm.contentSourceUrl"></el-input>
            </el-form-item>
