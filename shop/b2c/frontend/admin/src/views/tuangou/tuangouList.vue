      ...
      <div class="modal-body">
        <div class="set-style">
          ...
          <dl>
            <dt>团购类型:</dt>
            <dd>
              <div class="selectric-wrapper selectric-select-common" style="width: 250px;"><div class="selectric-hide-select"><select id="type_val" class="select-common" onchange="tuangou_type()" tabindex="-1">
