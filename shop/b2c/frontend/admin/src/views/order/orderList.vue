<template>
  <section class="ns-base-section">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <!-- <el-tab-pane :name="3" label="待提货" /> -->
      <el-tab-pane :name="4" label="已发货" />
      <el-tab-pane :name="5" label="已收货" />
      <el-tab-pane :name="6" label="已完成" />
      <el-tab-pane :name="7" label="已关闭" />
      <el-tab-pane :name="8" label="退款中" />
    </el-tabs>
    ...
    <el-dialog :visible.sync="dialogUpdateMemosFormVisible" title="备注信息" size="small" >
      <el-form ref="updateMemosForm" :model="updateMemosForm" size="small" label-width="100px" >

        <el-form-item label="备注">
          <el-input v-model="updateMemosForm.memos" type="textarea" rows="3" />
        </el-form-item>
            ...
            <div class="modal-body">
                ...
                <ul class="edit-price-amountpay">
                    <li>
                        ...
                        <span class="amountpay-price" data-id="goodsmoney"></span>元&nbsp;&nbsp;&nbsp;
                        <span class="amountpay-label">商品优惠：</span>
                        <span class="amountpay-price" data-id="discountmoney"></span>元&nbsp;&nbsp;&nbsp;
                        <span class="amountpay-label">运费：</span>
                        <span class="amountpay-price" data-id="modifiedFreight"></span>元
                    </li>
                    <li>
                        <div>
                            实收款： <span class="amountpay-price reality-price" data-id="changeTotal"></span>元
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group" data-id="express_input">
                  <select class="form-control input-lg" data-id="o2o_delivery_user" />
                ...
                <div>
                  ...
                  <textarea class="remark textarea-common" style=" width: 440px;height: 80px;" maxlength="500" />
                </div>
              </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2"><textarea id="pickup_desc" class="textarea-common" /></div>
                </div>
                          ...
                          <div class="address_choice">
                              <div class="selectric-wrapper selectric-select-common selectric-harf" style="width: 125px;">
                                  <div class="selectric-hide-select">
                                      <select name="province" data-id="seleAreaNext" onchange="GetProvince();" class="select-common harf" tabindex="-1">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="refunds-block">
                <label>退款方式：</label>
                <select id="refund_way_select" class="select-common" />
              </div>
              <div class="refunds-block">
            ...
            <div class="modal-footer">
              <!-- 温馨提示 -->
              <div class="refunds-block js-not-configured-prompt" />
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <label>备注：</label>
              <textarea rows="4" placeholder="退款备注，最多可输入200个字符。(如果不填，系统将会自动添加默认退款备注，格式为：订单编号:201710180000031，退款方式为:[微信支付]，退款金额:0.00元，退款余额:0.00元)" data-id="refund-remark" />
              <div class="refunds-block js-confirmation-prompt" />
              <div style="clear: both;" />
            </div>
            <div class="modal-footer">
              <!-- 温馨提示 -->
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <div style="height: 35px;line-height: 35px;">
                          ...
                          <label for="yes" style="display: inline-block;font-weight: normal;margin-left: 15px;">是</label><input type="radio" name="isStorage" data-id="yes" style="margin-top: -2px;margin-left: 5px;">
                      </div>
