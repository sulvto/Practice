			...
			<!-- 面包屑导航 -->
				...
				<a href="http://b2c.niuteam.cn/admin.html">单商户B2C</a>
					...
					<a href="http://b2c.niuteam.cn/admin/order/orderlist.html">订单</a>
									<i class="fa fa-angle-right"></i>
					<!-- 需要加跳转链接用这个：http://b2c.niuteam.cn/admin/order/virtualorderlist -->
					<a href="javascript:;" style="color:#999;">虚拟订单</a>
							</div>
						<!-- 三级导航菜单 -->
			
								<nav class="ns-third-menu">
					<ul>
												<li class="selected" onclick="location.href='http://b2c.niuteam.cn/admin/order/virtualorderlist.html';">全部</li>
													<li onclick="location.href='http://b2c.niuteam.cn/admin/order/virtualorderlist.html?status=0';">待付款</li>
													<li onclick="location.href='http://b2c.niuteam.cn/admin/order/virtualorderlist.html?status=6';">已付款</li>
													<li onclick="location.href='http://b2c.niuteam.cn/admin/order/virtualorderlist.html?status=4';">已完成</li>
													<li onclick="location.href='http://b2c.niuteam.cn/admin/order/virtualorderlist.html?status=5';">已关闭</li>
											</ul>
				</nav>
...
<div class="page" id="turn-ul" style="">
	<div class="pagination">
		<ul>
			...
			<li id="pageNumber"><a onclick="JumpForPage(this)" class="currentPage">1</a><a onclick="JumpForPage(this)">2</a><a onclick="JumpForPage(this)">3</a><a onclick="JumpForPage(this)">4</a></li>
			<li id="JslastPage"></li>
			<li><a id="nextPage">下一页</a></li>
			<li><a id="lastPage">末页</a></li>
			<li class="total-data" data-total-count="53">共53条</li>
...
<input type="hidden" id="page_count" value="4">
