<template>
    <header class="ns-base-header">
			<div class="ns-logo" @click="$router.push('/admin.html');"></div>

			<div class="ns-search">
				<div class="nav-menu js-nav">
					<img src="/static/blue/img/nav_menu.png" title="导航管理">
				</div>
			...
			<nav>
				<ul>
					<li class="selected" @click="$router.push('/index.html');">
						<span>首页</span>
					</li>

					<li @click="$router.push('/goods/list.html');">
						<span>商品</span>
					</li>
					<li @click="$router.push('/order/orderlist.html');">
						<span>订单</span>
					</li>
					<li @click="$router.push('promotion/coupontypelist.html');">
						<span>营销</span>
					</li>
					<li @click="$router.push('member/memberlist.html');">
						<span>会员</span>
					</li>
					<li @click="$router.push('/account/shopsalesaccount.html');">
						<span>数据</span>
					</li>
					<li @click="$router.push('/wchat/config.html');">
						<span>微信</span>
					</li>
					<li @click="$router.push('/config/usernotice.html');">
						<span>网站</span>
					</li>
					<li @click="$router.push('/config/webconfig.html');">
						<span>设置</span>
					</li>
					<li @click="$router.push('/upgrade/onlineupdate.html');">
						<span>系统</span>
					</li>
				</ul>
			</nav>
...
.ns-base-tool {
  ...
  > i[class*="i-"] {
    background: url(/static/blue/img/base_tool.png) no-repeat;
    display: inline-block;
    width: 20px;
    height: 20px;
    vertical-align: middle;
...
.ns-base-tool .ns-upgrade img,
.ns-base-tool .ns-clear img,
.ns-home img {
  vertical-align: middle;
  margin-top: -3px;
}
...
.ns-navigation-management::-webkit-scrollbar,
.ns-navigation-management dl::-webkit-scrollbar {
  width: 2px;
  height: 2px;
}
...
.ns-logo {
  ...
  line-height: 50px;
  cursor: pointer;
  background: #393939 url(/static/bliu/img/top_logo.png) no-repeat;
  background-size: 65%;
