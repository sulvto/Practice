...
<div id="header-div">
    ...
    <div id="submenu-div">
        <ul>
            <li><a href="/index" target="_blank">查看网店</a></li>
            <li><a href="#" target="main-frame">个人设置</a></li>
            <li style="border-right:none"><a href="/system/nav">刷新</a></li>
        </ul>
        <div id="send_info">
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="__GROUP__/Index/main" target="main-frame">起始ss页</a></li>
        <li><a href="/system/pro" target="main-frame">商品列表</a></li>
