		...
		<div class="main">
			<div class="mainunit01">
				...
				<div class="main02right">
					...
					${error}
					<div class="hyzc">
						<form action="/register?cmd=regist" method="post">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td><input name="email" type="text" class="fkklsj"
										required /></td>
								</tr>
								<tr>
									<td><div align="right">密码：</div></td>
									<td><input name="password" type="password" class="fkklsj"
										required /></td>
								</tr>
								<tr>
									<td><div align="right">确认密码：</div></td>
									<td><input name="rePwd" type="password" class="fkklsj"
										required /></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td><img src="images/hs_03.jpg" onclick="submitForm()" name="Image13" width="80" height="23"
											border="0" id="Image13" /> </a></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td class="zcdbc">我已经有了账号，我要<span class="lvse"><a
											href="#">登录</a></span><br /> 忘记密码了吗？<span class="lvse"><a
											href="#">点击</a></span>找回密码
									</td>
								</tr>
							</table>
