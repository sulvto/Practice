            ...
            <div style="border: 1px solid #cecece;">
                ...
                <s:form id="resourceForm" action="resource_save">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr bgcolor="#FFFFFF">
                            <td width="22%" align="center">method</td>
                            <td width="29%"><s:textfield name="method" label="method"/></td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                            <td width="22%" align="center">desc</td>
                            <td width="29%"><s:textarea name="desc" label="desc"
                                                        style="width: 520px; height: 100px;"/></td>
                        </tr>
