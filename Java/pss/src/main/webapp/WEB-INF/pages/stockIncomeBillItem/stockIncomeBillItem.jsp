...
<title>成都蓝源进销存系统(教学版)-stockIncomeBillItem列表页</title>
</head>
<body>
	...
	<div class="content-text">
			<s:form id="domainForm" action="stockIncomeBillItem" theme="simple">
				<div class="square-o-top">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td width="136"><a href="stockIncomeBillItem_input.action"><img
							...
							<tr align="center" bgcolor="#FFFFFF">
								...
								<td><img src="images/icon_3.gif" /> <span
									style="line-height: 12px; text-align: center;"> <a
										class="xiu" href="#"
										onclick="updateDomain('stockIncomeBillItem',${id});">修改</a></span> <img
									src="images/icon_04.gif" /> <span
									style="line-height: 12px; text-align: center;"> <a
										class="xiu" href="#"
										onclick="deleteDomain('stockIncomeBillItem_delete.action',${id},this);">删除</a>
								</span></td>
							</tr>
						</s:iterator>
						<!--"container"end-->
