...
<title>成都蓝源进销存系统(教学版)-systemDictionaryDetail列表页</title>
</head>
<body>
...
<%-- 							onchange="dept();"></s:select></td> --%>
					<td width="85"><a href="#" onclick="go();"><img
							src="images/can_b_01.gif" border="0" /></a></td>
					<td width="136"><a href="systemDictionaryDetail_input.action"><img
...
<%-- 						<td>${department.name}</td> --%>
						<td><img src="images/icon_3.gif" /> <span
							style="line-height: 12px; text-align: center;"> <a
								class="xiu" href="#" onclick="updateDomain('systemDictionaryDetail',${id});">修改</a></span>
							<img src="images/icon_04.gif" /> <span
							style="line-height: 12px; text-align: center;"> <a
								class="xiu" href="#"
								onclick="deleteDomain('systemDictionaryDetail_delete.action',${id},this);">删除</a>
						</span></td>
					</tr>
				</s:iterator>
				<!--"container"end-->
