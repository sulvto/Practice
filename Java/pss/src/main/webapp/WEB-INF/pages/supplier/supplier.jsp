...
<title>成都蓝源进销存系统(教学版)-supplier列表页</title>
</head>
<body>
		...
		<div class="square-o-top">
			<table width="100%" border="0" cellpadding="0"
				...
				<tr>
					...
					<td width="136"><a href="supplier_input.action"><img
...
<%-- 						<td>${department.name}</td> --%>
						<td><img src="images/icon_3.gif" /> <span
							style="line-height: 12px; text-align: center;"> <a
								class="xiu" href="#" onclick="updateDomain('supplier',${id});">修改</a></span>
							<img src="images/icon_04.gif" /> <span
							style="line-height: 12px; text-align: center;"> <a
								class="xiu" href="#"
								onclick="deleteDomain('supplier_delete.action',${id},this);">删除</a>
						</span></td>
					</tr>
				</s:iterator>
				<!--"container"end-->
