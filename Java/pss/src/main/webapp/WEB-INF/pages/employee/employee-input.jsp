			...
			<div class="square-order">
				<div style="border: 1px solid #cecece;">
					...
					<s:form id="employeeForm" action="employee_save">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr bgcolor="#FFFFFF">
								<td width="22%" align="center"><s:textfield name="name" label="用户名" /></td>
							</tr>
							<s:if test="id==null">
								<tr bgcolor="#FFFFFF">
									<td width="22%" align="center">密码</td>
									<td width="29%"><s:textfield name="password" size="25" /></td>
								</tr>
							</s:if>
							<tr bgcolor="#FFFFFF">
							...
							<tr bgcolor="#FFFFFF">
								...
								<td><s:select list="#allDepts" name="department.id"
										listKey="id" listValue="name" headerKey="-1"
										headerValue="--请选择--" /></td>
							</tr>
							<tr bgcolor="#FFFFFF">
								<td align="center">role</td>
								<td><s:checkboxlist list="#allRoles" name="ids"
										listKey="id" listValue="name" label="role">
									</s:checkboxlist></td>
							</tr>
						</table>
					</s:form>
