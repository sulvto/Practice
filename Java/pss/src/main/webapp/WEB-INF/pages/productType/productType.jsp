...
<head>
    ...
    <title>成都蓝源进销存系统(教学版)-productType列表页</title>
</head>
<body>
    ...
    <div class="content-text">
        <div class="square-o-top">
            ...
            <tr>
                ...
                <td width="136"><a href="productType_input.action"><img
                ...
                <s:iterator value="pageResult.rows">
                    <tr align="center" bgcolor="#FFFFFF">
                        ...
                        <td><img src="images/icon_3.gif"/> <span
                                ...
                                class="xiu" href="#" onclick="updateDomain('productType',${id});">修改</a></span>
                            <img src="images/icon_04.gif"/> <span
                                    style="line-height: 12px; text-align: center;"> <a
                                    class="xiu" href="#"
                                    onclick="deleteDomain('productType_delete.action',${id},this);">删除</a>
						</span></td>
                    </tr>
                </s:iterator>
                <!--"container"end-->
