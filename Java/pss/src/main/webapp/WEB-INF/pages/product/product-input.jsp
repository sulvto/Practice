				...
				<div style="border: 1px solid #cecece;">
					...
					<s:form id="productForm" action="product_save"
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td><s:textfield name="name" label="名称" /></td>
								<td><s:textfield name="color" label="颜色" theme="simple" /></td>
							</tr>
							<tr>
								<td><s:textfield name="costPrice" label="costPrice" /></td>
								<td><s:textfield name="salePrice" label="salePrice" /></td>
							</tr>
							<tr>
								<td><s:select id="parent" list="#allParents"
										name="types.parent.id" listKey="id" listValue="name"
										headerKey="-1" headerValue="-请选择-"
										onchange="findChildren(this)" label="产品类型"></s:select> <s:select
										id="children" list="#allChildrens" name="types.id"
										listKey="id" listValue="name"></s:select></td>
								<td><s:select list="#allBrands" name="brand.id"
										listKey="id" listValue="name" label="品牌"></s:select> <s:select
